...
if "light" == &bg
  ...
  if !s:mimic_dejavu_dark
    ...
    if !s:mimic_dejavu_alt
      ...
      hi ModeMsg	guifg=#44fec8	guibg=#b0b0b0	gui=NONE	ctermfg=green	ctermbg=darkgray	cterm=NONE
    else
      hi StatusLineNC	guifg=#b0b0b0	guibg=#101060	gui=NONE	ctermfg=cyan	ctermbg=blue	cterm=NONE
      hi VertSplit	guifg=#b0b0b0	guibg=#101060	gui=NONE	ctermfg=cyan	ctermbg=blue	cterm=NONE
  ...
  if version >= 700
    ...
    " popup completion menu
    hi Pmenu	guifg=bg	guibg=#b0b0b0	gui=NONE	ctermfg=bg	ctermbg=cyan	cterm=NONE
    hi PmenuSel	guifg=#b0b0b0	guibg=bg	gui=NONE	ctermfg=cyan	ctermbg=bg	cterm=NONE
